...
<div class="form">
<springform:form modelAttribute="branchAdminUpdate" method="post" action="updatebranchadmin.htm">
<table>
<tr>
...
<td><springform:input path="branchAdminId" readonly="true" 
      style="height : 30px;" id="first_name"
...
<tr>
<td>
<springform:label path="branchAdminGender">Gender:      </springform:label>
...
<td><springform:input path="branchAdminDOB" id="dob" 
     type="date" placeholder="qwweqd" style="height : 30px;"
...
<td><springform:input path="branchAdminContactNo"
   placeholder="Contact Number" style="height : 30px;"
			...
			onkeypress="return isNumber(event)" /> 
<springform:errors path="branchAdminContactNo" style="color:red"/>
